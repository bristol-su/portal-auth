...
class WebTest extends TestCase
{
    ...
    {
        $authentication = resolve(WebControlResolver::class);
    ...
    public function get_group_returns_a_group_if_given_in_url()
    {
        ...
        $query->has('r')->shouldBeCalled()->willReturn(false);
        $query->has('g')->shouldBeCalled()->willReturn(true);
        $query->get('g')->shouldBeCalled()->willReturn($group->id());
    ...
    public function get_group_returns_a_group_given_by_a_role_if_role_given(){
        ...
        $query = $this->prophesize(ParameterBag::class);
        $query->has('r')->shouldBeCalled()->willReturn(true);
        $query->get('r')->shouldBeCalled()->willReturn($role->id());
    ...
    public function getGroup_returns_null_if_exception_thrown_in_repository(){
        ...
        $query->has('r')->shouldBeCalled()->willReturn(false);
        $query->has('g')->shouldBeCalled()->willReturn(true);
        $query->get('g')->shouldBeCalled()->willReturn(1);
    ...
    public function getRole_returns_null_if_exception_thrown_in_repository(){
        $query = $this->prophesize(ParameterBag::class);
        $query->has('r')->shouldBeCalled()->willReturn(true);
        $query->get('r')->shouldBeCalled()->willReturn(1);
